...
struct ConnectionParameters
{
   ...
   bool mUseArrangedSecretAsSharedSecret; ///< Set to true if the arranged connection secret data should be used as the symmetric key for symmetric crypto
   ...
   ConnectionParameters()
   {
      ...
      mUsingCrypto = false;
      mUseArrangedSecretAsSharedSecret = false;
      mIsArranged = false;
#ifdef TNL_DEBUG
...
public:
   ...
   void connectArranged(NetInterface *connectionInterface, const Vector<Address> &possibleAddresses, Nonce &myNonce, Nonce &remoteNonce, ByteBufferPtr sharedSecret, bool isInitiator, bool requestsKeyExchange = false, bool requestsCertificate = false, bool useArrangedSecretAsSharedSecret = false);
